...
final class Schema7 extends i0.VersionedSchema {
  ...
  late final Shape6 selfCheckResultEntries = Shape6(
    source: i0.VersionedTable(
      entityName: 'self_check_result_entries',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(profile_id)'],
      columns: [_column_23, _column_24, _column_25, _column_26],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
class Shape6 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get verdict =>
      columnsByName['verdict']! as i1.GeneratedColumn<String>;
