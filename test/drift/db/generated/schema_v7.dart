...
class SelfCheckResultEntries extends Table
    with TableInfo<SelfCheckResultEntries, SelfCheckResultEntriesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SelfCheckResultEntries(this.attachedDatabase, [this._alias]);
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'self_check_result_entries';
  @override
  Set<GeneratedColumn> get $primaryKey => {profileId};
  @override
  SelfCheckResultEntriesData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return SelfCheckResultEntriesData(
  ...
  @override
  SelfCheckResultEntries createAlias(String alias) {
    return SelfCheckResultEntries(attachedDatabase, alias);
  }
}

class SelfCheckResultEntriesData extends DataClass
    implements Insertable<SelfCheckResultEntriesData> {
  final String profileId;
  final String itemsJson;
  final String verdict;
  final DateTime generatedAt;
  const SelfCheckResultEntriesData({
  ...
  SelfCheckResultEntriesCompanion toCompanion(bool nullToAbsent) {
    return SelfCheckResultEntriesCompanion(
  ...
  factory SelfCheckResultEntriesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  SelfCheckResultEntriesData copyWith({
    String? profileId,
    String? itemsJson,
    String? verdict,
    DateTime? generatedAt,
  }) => SelfCheckResultEntriesData(
    profileId: profileId ?? this.profileId,
    itemsJson: itemsJson ?? this.itemsJson,
    verdict: verdict ?? this.verdict,
    generatedAt: generatedAt ?? this.generatedAt,
  );
  SelfCheckResultEntriesData copyWithCompanion(
    SelfCheckResultEntriesCompanion data,
  ) {
    return SelfCheckResultEntriesData(
  ...
  @override
  String toString() {
    return (StringBuffer('SelfCheckResultEntriesData(')
  ...
  @override
  int get hashCode => Object.hash(profileId, itemsJson, verdict, generatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is SelfCheckResultEntriesData &&
...
class SelfCheckResultEntriesCompanion
    extends UpdateCompanion<SelfCheckResultEntriesData> {
  final Value<String> profileId;
  final Value<String> itemsJson;
  final Value<String> verdict;
  final Value<DateTime> generatedAt;
  final Value<int> rowid;
  const SelfCheckResultEntriesCompanion({
  ...
  SelfCheckResultEntriesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       verdict = Value(verdict),
       generatedAt = Value(generatedAt);
  static Insertable<SelfCheckResultEntriesData> custom({
  ...
  SelfCheckResultEntriesCompanion copyWith({
  ...
  @override
  String toString() {
    return (StringBuffer('SelfCheckResultEntriesCompanion(')
          ..write('profileId: $profileId, ')
          ..write('itemsJson: $itemsJson, ')
          ..write('verdict: $verdict, ')
          ..write('generatedAt: $generatedAt, ')
...
class DatabaseAtV7 extends GeneratedDatabase {
  ...
  late final SelfCheckResultEntries selfCheckResultEntries =
      SelfCheckResultEntries(this);
  @override
